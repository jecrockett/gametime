...
function Player(id, name, x, y) {
 ...
 Player.prototype = {
  move: function(keysPressed) {
    if ((keysPressed[37] || keysPressed[65]) && this.canMoveLeft()) { this.moveLeft(); }
    if ((keysPressed[39] || keysPressed[68]) && this.canMoveRight()) { this.moveRight(); }
    if ((keysPressed[40] || keysPressed[83]) && this.canMoveDown()) { this.moveDown(); }
    if ((keysPressed[38] || keysPressed[87]) && this.canMoveUp()) { this.moveUp(); }
  },
